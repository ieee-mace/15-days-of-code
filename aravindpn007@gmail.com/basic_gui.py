...
check_button = Button(root, text='Check', command=grab_price)
...
add_button_url = Button(root, text='Add')
add_button_url.grid(row=1, column=1)

add_button_price = Button(root, text='Add')
add_button_price.grid(row=2, column=1)
